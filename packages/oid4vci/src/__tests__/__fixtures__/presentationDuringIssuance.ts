export const presentationDuringIssuance = {
  credentialOffer:
    'openid-credential-offer://?credential_offer=%7B%22credential_issuer%22%3A%22https%3A%2F%2Fpresentation-during-issuance.com%22%2C%22credential_configuration_ids%22%3A%5B%22pid-sd-jwt%22%5D%2C%22grants%22%3A%7B%22authorization_code%22%3A%7B%7D%7D%7D',
  credentialOfferObject: {
    credential_issuer: 'https://presentation-during-issuance.com',
    credential_configuration_ids: ['pid-sd-jwt'],
    grants: { authorization_code: {} },
  },
  authorizationServerMetadata: {
    issuer: 'https://presentation-during-issuance.com',
    authorization_endpoint: 'https://presentation-during-issuance.com/authorize',
    token_endpoint: 'https://presentation-during-issuance.com/token',
    pushed_authorization_request_endpoint: 'https://presentation-during-issuance.com/par',
    authorization_challenge_endpoint: 'https://presentation-during-issuance.com/challenge',
  ...
  credentialIssuerMetadata: {
    credential_issuer: 'https://presentation-during-issuance.com',
    credential_endpoint: 'https://presentation-during-issuance.com/credential',
  ...
  authorizationChallengeErrorResponse: {
    ...
    presentation: 'openid4vp://?client_id=something&request_uri=something-else',
    auth_session: 'auth-session-identifier',
    error_description: 'Presentation of credentials required before issuance',
  },
